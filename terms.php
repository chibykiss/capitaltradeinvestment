...
<!-- Document Title
    ============================================= -->
<title>Terms and Conditions | Capitaltrade Investment </title>
</head>
<body>
<div class="preloader">
...
<section>
    <div class="container">
        <div class="heading-text heading-line text-center">
            ...
            <div class="row">
            <div class="col-lg-12">
            <p class="heading--subtitle">Capitaltrade Investment</p>    
            ...
            <div class="text-container">
                ...
                <p class=" ">
                    11.4 Notices – Unless otherwise agreed, all notices, instructions and other communications to be given by the Company shall be given to the address or fax number provided by the Client, or via e-mail or other electronic means, details of which are provided by the Client to the Company. Any changes in the Details or any complaint shall be directed to the Company’s client services department, who will investigate the complaint and make every effort to resolve it. Such complaints should be made to: support@btcoptionmarket.com.
                </p>
                <p class=" ">
                    TC-first-paragraph
                </p>
                ...
                <p class=" ">
                    BTC Wallet Funds Risk Disclosure
                </p>
                <p class=" ">
                    Trading in Cryptocurrency Options is considered a risky and speculative investment venue.
                </p>
                <p class=" ">
                    The relevant markets for Trading are characterized as high volatile markets, which inherits high risk in evaluating the outcome of a Cryptocurrency option. The Company is not and will not, in any way, be responsible to the outcome of any transaction executed by the Client.
                </p>
                <p class=" ">
