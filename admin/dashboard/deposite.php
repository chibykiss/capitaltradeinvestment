...
<head>
    ...
    <title>  Crypstaccel Tradefast   || Admin Dashboard || Deposite </title>
    <!-- ================= Favicon ================== -->
    <?php
                                ...
                                <div class="card">
                                    <div class="panel panel-primary">
                                        <div class="panel-header">
                                            <h4 class="text-center"> Total Deposite</h4>
                                            <h4 class="text-center"> Amount : $<?php $classObj->total_depsite(); ?> </h4>
                                        </div>
