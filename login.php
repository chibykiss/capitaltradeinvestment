...
<head>
    ...
    <title>Login | capitaltrade investment</title>
    ...
    <div class="card-inner card-inner-lg">
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                ...
                <?php $classObj->sobologin(); ?>
                <div class="form-group">
                <div class="form-label-group">
                    <label class="form-label" for="username">Email Address <span class="text-danger">*</span></label>
                </div>
                <div class="form-control-wrap">
                    <input name="username" type="email" autocomplete="new-email" class="form-control form-control-lg" id="username" placeholder="Enter your email address" autocomplete="off" data-msg-email="Enter a valid email." data-msg-required="Required." required>
                </div>
            </div>
            <div class="form-group">
                <div class="form-label-group">
                ...
                <div class="form-control-group d-flex justify-between mt-2 mb-gs">
                    ...
                    <div class="form-control-link">
                        <a tabindex="5" class="link link-primary" href="forgot">Forgot Code?</a>
                    </div>
                </div>
            </div>
                <div class="form-group">
                        <button name="sobo" type="submit" class="btn btn-lg btn-primary btn-block">Login</button>
                </div>
        </form>
...
<!-- <script src="https://trade.ai-marketinginvestment.com/assets/js/bundle.js"></script>
<script src="https://trade.ai-marketinginvestment.com/assets/js/app.js"></script>-->
