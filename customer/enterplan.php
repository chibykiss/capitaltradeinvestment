...
<head>
    ...
    <title>  Capitaltrade Investment  || User Dashboard || Compound Investment </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    ...
    <script>
       $(document).ready(function() {
           ...
           $('#invest').submit(function(e){
                ...
                $.get("invest.php?plan="+plan+"&amount="+amount+"&bal="+bal+"&dura="+dura+"&pect="+pect, function(data){
                    if (data == 'getfund') {
