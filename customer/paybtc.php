...
<head>
    ...
    <title>  Capitaltrade Investment  || User Dashboard || New deposit With BTC </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
          <!-- Styles -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">BTC DEPOSIT</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="panel panel-primary">
                                    <div class="panel-header">
                                        ...
                                        <h4 class="text-center">Deposit fund to your account using btc transfer. </h4>
                                    </div>
                                    <div class="panel-body text-center">
                                        <h5 class="text-center">Account Balance &#8364;<?php $classObj->getbal(); ?> </h5>
                                          <?php $classObj->btcpull(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            //var bt =  $("#bt").val();
                 $('#mybt').click(function(){
                    $("#mybtc").select();
                        ...
                        swal(" The BTC address has been copied successfully ", btc);
                 });
          });
    </script>
</body>
