...
<head>
    ...
    <title> Crypstaccel Tradefast   || User Dashboard || Compound Investment </title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                                        ...
                                        <form class="form-horizontal" id="invest">
                                            ...
                                            <div class="input-group">
                                                 <span class="input-group-addon">$</span>
                                                     ...
                                                     <input type="hidden" id="plan" value="compound">   
                                                     <input  type="number" id="amount"  min="10000"  class="form-control"  placeholder="Enter Amount" required />
                                            </div>   
