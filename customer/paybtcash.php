...
<head>
    ...
    <title>  Capitaltrade Investment  || User Dashboard || New deposite With Bitcoin cash</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
          <!-- Styles -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">BITCOIN CASH DEPOSIT</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="panel panel-primary">
                                    <div class="panel-header">
                                        <h4 class="text-center">Deposite fund to your account using Bitcoin cash transfer. </h4>
                                    </div>
                                    <div class="panel-body text-center">
                                        <h5 class="text-center">Account Balance $<?php $classObj->getbal(); ?> </h5>
                                          <?php $classObj->btccpull(); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            //var bt =  $("#bt").val();
                 $('#mybt').click(function(){
                    $("#mybtc").select();
                        ...
                        swal(" The BITCOIN CASH address has been copied successfully ", btc);
                 });
          });
    </script>
</body>
